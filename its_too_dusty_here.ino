...
//#define LOAD_RESISTANCE_VAL 5
//#define GAS_RES_SAMPLE_VAL 50
...
void loop() {
  ...
  //  gas_digest(ratio);
  //  Serial.println(air_.gas[0]);
  //  Serial.println(air_.reading[0]);
  //
  //  Serial.println(air_.gas[1]);
  //  Serial.println(air_.reading[0]);
  //
  //  Serial.println(air_.gas[2]);
  //  Serial.println(air_.reading[0]);
  ...
  */
  ...
  data = "{\"dust\":" + String(dust_samp) + ","\"0\":{\"gas\":" + String(air_.gas[0]) + ",\"reading\":" + String(air_.reading[0]) + "},\"1\":{\"gas\":" + String(air_.gas[1]) + ",\"reading\":" + String(air_.reading[1]) + "},\"2\":{\"gas\":" + String(air_.gas[2]) + ",\"reading\":" + String(air_.reading[2]) + "}}";
...
//
//  raw_read = raw_read * (LOAD_RESISTANCE_VAL / 1023);
//
...
//    gas_percent(ratios, gas_curve_data[i]);
//    Serial.println(gas_percent(ratios, gas_curve_data[i]));
//  }
//}
//
